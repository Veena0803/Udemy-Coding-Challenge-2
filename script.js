...
var yearOfBirth = [2007, 1985, 1993, 1956, 1959];
var age = [];
    ...
    for(var j = 0; j < age.length; j++)
        {
            ...
            if(this.age[j] > 18)
                {
                    console.log('Person ' + (j + 1) + ' is ' + age[j] + ' years old, and is of full age');
                    bArr.push(true);   
                    
                }
            else
            {
                console.log('Person ' + (j + 1) + ' is ' + age[j] + ' years old, and is not of full age');
                bArr.push(false);
            }
             console.log(bArr);
        }
